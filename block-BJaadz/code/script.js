...
allHrs.forEach((eachHr) => eachHr.style.border = '1px solid tomato') 
...
allHrsArray.forEach((eachHr) => eachHr.style.borderRadius = '5px')
...
allHrs.forEach((eachHr) => eachHr.style.borderStyle = 'dashed')
...
// let allElementsBoxOne = document.querySelector('.one').childNodes
// allElementsBoxOne.forEach((eachElement) => eachElement.remove())
let allElementsBoxOne = document.querySelector('.one');
allElementsBoxOne.innerHTML = ''

// Replace all the elements inside box 1 with the para (you created above)

allElementsBoxOne.append(para)
